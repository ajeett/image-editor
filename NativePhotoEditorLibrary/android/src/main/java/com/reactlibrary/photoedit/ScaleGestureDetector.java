...
class ScaleGestureDetector {
    ...
    private com.reactlibrary.photoedit.Vector2D mCurrSpanVector;
    ...
    ScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new com.reactlibrary.photoedit.Vector2D();
    }
    ...
    com.reactlibrary.photoedit.Vector2D getCurrentSpanVector() {
