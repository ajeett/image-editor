...
import com.reactlibrary.photoedit.MultiTouchListener;
...
public class PhotoEditorSDK implements MultiTouchListener.OnMultiTouchListener {
    ...
    public void addImage(Bitmap desiredImage) {
        ...
        if (onPhotoEditorSDKListener != null)
            onPhotoEditorSDKListener.onAddViewListener(com.reactlibrary.photoedit.ViewType.IMAGE, addedViews.size());
    }
    ...
    public void addText(String text, int colorCodeTextView) {
        ...
        if (onPhotoEditorSDKListener != null)
            onPhotoEditorSDKListener.onAddViewListener(com.reactlibrary.photoedit.ViewType.TEXT, addedViews.size());
    }
    ...
    public void addEmoji(String emojiName, Typeface emojiFont) {
        ...
        if (onPhotoEditorSDKListener != null)
            onPhotoEditorSDKListener.onAddViewListener(com.reactlibrary.photoedit.ViewType.EMOJI, addedViews.size());
    }
