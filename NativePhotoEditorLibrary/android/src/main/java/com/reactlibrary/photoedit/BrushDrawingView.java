...
public class BrushDrawingView extends View {
    ...
    public void setOnPhotoEditorSDKListener(com.reactlibrary.photoedit.OnPhotoEditorSDKListener onPhotoEditorSDKListener) {
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (onPhotoEditorSDKListener != null)
                        onPhotoEditorSDKListener.onStartViewChangeListener(com.reactlibrary.photoedit.ViewType.BRUSH_DRAWING);
                    break;
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    drawPath.reset();
                    if (onPhotoEditorSDKListener != null)
                        onPhotoEditorSDKListener.onStopViewChangeListener(com.reactlibrary.photoedit.ViewType.BRUSH_DRAWING);
                    break;
                default:
                    return false;
            }
