...
//                    startActivityForResult(getPickImageChooserIntent(), IMAGE_RESULT);
    ...
    protected String getPath(final Uri uri) {
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(this, uri)) {
            ...
            if (com.reactlibrary.GalleryUtils.isExternalStorageDocument(uri)) {
            ...
            // DownloadsProvider
            else if (com.reactlibrary.GalleryUtils.isDownloadsDocument(uri)) {
                final String id = DocumentsContract.getDocumentId(uri);
                final Uri contentUri = ContentUris.withAppendedId(
                        Uri.parse("content://downloads/public_downloads"),
                        Long.valueOf(id));
                return com.reactlibrary.GalleryUtils.getDataColumn(this, contentUri, null, null);
            }
            // MediaProvider
            else if (com.reactlibrary.GalleryUtils.isMediaDocument(uri)) {
                final String docId = DocumentsContract.getDocumentId(uri);
                final String[] split = docId.split(":");
                final String type = split[0];
                ...
                return com.reactlibrary.GalleryUtils.getDataColumn(this, contentUri, selection,
                        selectionArgs);
            }
        }
        // MediaStore (and general)
        else if ("content".equalsIgnoreCase(uri.getScheme())) {
            return com.reactlibrary.GalleryUtils.getDataColumn(this, uri, null, null);
        }
        // File
